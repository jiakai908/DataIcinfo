package com.icinfo.dataicinfo.worker.core.runtime;
...
public class WorkerConfig extends AbstractConfig {
    ...
    public static final String CLASSLOADER_TYPE_DEFAULT = "Dev";//三个选项，Dev-开发版，Rel-release版,Inherit-直接使用框架的Loader
    ...
    static {
        CONFIG = new ConfigDef()
                .define(BOOTSTRAP_SERVERS_CONFIG,
                        ConfigDef.Type.LIST, BOOTSTRAP_SERVERS_DEFAULT,
                ...
                .define(POSITION_COMMIT_INTERVAL_MS_CONFIG,
                        ConfigDef.Type.LONG, POSITION_COMMIT_INTERVAL_MS_DEFAULT,
                        ConfigDef.Importance.LOW, POSITION_COMMIT_INTERVAL_MS_DOC)
                ...
                .define(REST_PORT_CONFIG,
                        ConfigDef.Type.INT, REST_PORT_DEFAULT,
                        ConfigDef.Importance.LOW, REST_PORT_DOC)
